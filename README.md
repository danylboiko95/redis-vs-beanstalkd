...
According to the results, it turned out that beanstalkd is faster in **!!! circumstances if redis uses pub/sub!!!** . With normal compare almost no differences 

# **Redis AOF** !Important: with pub/sub
...
# **Redis RDB** !Important: with pub/sub
...
# **Beanstalkd** !Important: without pub/sub
